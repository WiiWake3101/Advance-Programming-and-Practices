...
public class RA2211003010002_Week_8_Question2 {
    public static void main(String[] args) {
        AirlineReservationSystem RA2211003010002_ars = new AirlineReservationSystem();
        Scanner scan = new Scanner(System.in);
        int RA2211003010002_option = 0;
        while (RA2211003010002_option != 4) {
            ...
            RA2211003010002_option = scan.nextInt();
            scan.nextLine();
            switch (RA2211003010002_option) {
                case 1:
                    System.out.println("Enter flight number:");
                    String flightNumber = scan.nextLine();
                    System.out.println("Enter passenger name:");
                    String passengerName = scan.nextLine();
                    int reservationId = RA2211003010002_ars.bookTicket(flightNumber, passengerName);
                    System.out.println("Successfully booked ticket with reservation ID: " + reservationId);
                    break;
                case 2:
                    System.out.println("Enter reservation ID:");
                    reservationId = scan.nextInt();
                    RA2211003010002_ars.cancelTicket(reservationId);
                    break;
                case 3:
                    RA2211003010002_ars.displayReservations();
                    break;
                case 4:
                    System.out.println("Exiting...");
                    break;
                default:
                    System.out.println("Invalid RA2211003010002_option. Please enter a number between 1 and 4.");
                    break;
            }
        }
        scan.close();
