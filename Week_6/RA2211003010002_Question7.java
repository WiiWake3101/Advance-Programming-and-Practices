...
class Rectangle implements Resizable {
    private int RA2211003010002_width;
    private int RA2211003010002_height;

    public Rectangle(int width, int height) {
        this.RA2211003010002_width = width;
        this.RA2211003010002_height = height;
    }
    ...
    public void displaySize() {
        System.out.println("Width: " + RA2211003010002_width + ", Height: " + RA2211003010002_height);
    }
}
public class RA2211003010002_Question7{
