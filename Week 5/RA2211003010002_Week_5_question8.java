...
public class RA2211003010002_Week_5_question8{
    public static void count_each_character(String RA2211003010002_text){
        int[] characterCounts = new int[255];
        for (int i = 0; i < RA2211003010002_text.length(); i++) {
            char c = RA2211003010002_text.charAt(i);
            characterCounts[c]++;
        }
    ...
    public static void main(String[] args) {
        ...
        String RA2211003010002_text=scanner.nextLine();
        count_each_character(RA2211003010002_text);
        scanner.close();
    }
}